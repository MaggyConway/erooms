<div class="main_news">
    <div class="container main_news">
        <div class="main_news-form">
            <img src="/local/templates/erooms/imgs/gray-big-form.png" alt="">
        </div>
        <div class="main_news-content">
            <div class="home-title-wrap flex align-items-center">
                <div class="home-title font-bold"><span>УМНЫЕ</span> НОВОСТИ</div>
                <div class="home-more-btn"><a href="/novosti/">

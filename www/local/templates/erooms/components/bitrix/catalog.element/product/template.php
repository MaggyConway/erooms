...
<div class="product_card bx-catalog-element bx-<?=$arParams['TEMPLATE_THEME']?>" id="<?=$itemIds['ID']?>"
	itemscope itemtype="http://schema.org/Product">
	

	<!-- СТИКЕР -->
	<div class="sticker product-item-label-text <?=$labelPositionClass?>" id="<?=$itemIds['STICKER_ID']?>"
...
<div class="product_flexbox">
	...
	<div class="slider_flexbox product-item-detail-slider-container" id="<?=$itemIds['BIG_SLIDER_ID']?>">
		...
		if ($showSliderControls) {
			if ($haveOffers) {
				foreach ($arResult['OFFERS'] as $keyOffer => $offer) {
					...
					$strVisible = $arResult['OFFERS_SELECTED'] == $keyOffer ? 'flex' : 'none'; ?>
		...
		<div id="<?=$itemIds['TAB_CONTAINERS_ID']?>">
			...
			if ($showDescription)
			{
				...
				<div class="product-item-detail-tab-content active" data-entity="tab-container" data-value="description"
					...
					{
						echo $arResult['PREVIEW_TEXT_TYPE'] === 'html' ? $arResult['PREVIEW_TEXT'] : '<p class="element_text">'.$arResult['PREVIEW_TEXT'].'</p>';
					}

					if ($arResult['DETAIL_TEXT'] != '')
					{
						echo $arResult['DETAIL_TEXT_TYPE'] === 'html' ? $arResult['DETAIL_TEXT'] : '<p class="element_text">'.$arResult['DETAIL_TEXT'].'</p>';
					}
					?>
				</div>
				<?
	...
	<div class="rightside">
		...
		<div class="detail_info product-item-detail-info-section">

			<div class="detail_info--top">


<? if ($actualItem['CAN_BUY']) {?>
				
				<div class="payblock"><div class="title">Стоимость:</div>
							...
							case 'buttons':
								...
								<div id="<?=$itemIds['BASKET_ACTIONS_ID']?>" style="display: <?=($actualItem['CAN_BUY'] ? '' : 'none')?>;">
									...
									if ($showAddBtn)
									{
										?>
										<div class="product-item-detail-info-container">
											<a class="btn_to_cart btn <?=$showButtonClassName?> product-item-detail-buy-button" id="<?=$itemIds['ADD_BASKET_LINK']?>"
				...
				<div class="choise"><div class="title">Цвет:</div>
					...
					<div class="one_click_to_buy">Купить в&nbsp;1&nbsp;клик</div>

				</div><!-- /choise -->


				<div class="info-props"><!-- для доступных товаров -->

					<div class="category"><span>Категория:</span>&nbsp;&nbsp;<?=$arResult["SECTION"]["NAME"]?></div>

				</div>
<?}?>

				<!-- <div class="info-props"> для недоступных товаров
				...
				<div class="not_available">
					<a class="not_available_link" id="<?=$itemIds['NOT_AVAILABLE_MESS']?>"
						href="javascript:void(0)"
						rel="nofollow" style="display: <?=(!$actualItem['CAN_BUY'] ? '' : 'none')?>;">

						<span class="icon_not_available"></span>
				...
				<?
					//echo "<pre>"; var_dump($actualItem['CAN_BUY']); echo "</pre>";
			...
			<? if ($actualItem['CAN_BUY']) {?>
				<div class="pay_and_delivery">
						
					<div class="tabs">
						<div class="tabs_title active" id="delivery_tab_title">Доставка</div>
						<div class="tabs_title" id="pay_tab_title">Оплата</div>
					</div>
					<div class="content">
						<div id="delivery_tab_content" class="tab_content show">

							<div class="delivery_choise">
								Доставка в&nbsp;&nbsp;&nbsp;<span>г.Санкт-Петербург</span>

								<div class="city_window">
									<ul>
										<li>г.Москва</li>
										<li>г.Казань</li>
										<li>г.Омск</li>
						...
						<div id="pay_tab_content" class="tab_content">robokassa</div>
					</div>
		...
		<div class="advantages">
			<ul>
				<li><span></span>Возможность возврата и&nbsp;обмена товара</li>
				<li><span></span>Гарантия от&nbsp;производителя</li>
				<li><span></span>100% оригинальная продукция</li>
			</ul>
		</div>
...
<!-- ГРУППОВЫЕ ПРЕДЛОЖЕНИЯ (НАБОРЫ ТОВАРОВ) --><?/*
<div class="row">
	<div class="col-xs-12">
		<?
		if ($haveOffers)
...
<!-- ЗАКРЕПЛЕННАЯ ВЕРХУШКА ОТКЛЮЧЕНА	 -->
	<!--Top tabs-->
